...
<div id='preview'>
    <header class='fl w100 p10-20'>
      <div class='f22 b6 dib'>Preview<small class='f14'> - Questions</small></div>
      <ul class='fr p5-10'>
        
        <li class='di p5-10 f12 dbNo'><button class='btn btn-default btn-xs'> <i class="fa fa-file-text-o" aria-hidden="true"></i> Default Cover Letter</button></li>
        ...
        <li class='di p5-10 f14 fr'><button class='btn btn-danger btn-xs'>Decline</button></li>
            <li class='di p5-10 f14 fr'><button class='btn btn-primary btn-xs'>Accept</button></li>
            <li class='di p5-10 f14 fr'><button class='btn btn-default btn-xs'>Assign Slab</button></li>
            <li class='di p5-10 f14 fr'>
                <select>
                  <option value='1' selected disabled>Price slab</option>
                  <option value='2'>Basic slab</option>
                  <option value='3'>Premium slab</option>
                </select>
            </li>
    ...
    <section id='preview_space' class='fl w100 p5-10'>
      <div v-show='true' id='question_set_' class='p5-10'>
        ...
        <div class='fl w30 p5-10'>
            <router-link to='./'><button class='btn btn-info btn-sm'>Back to Propsal List</button></router-link>
        </div>
